                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <option value="test-ride">Schedule Test Ride</option>
                                        ...
                                        <button
                                            type="submit"
                                            className="w-full bg-primary hover:bg-primary-dark text-white py-4 rounded-md font-semibold transition-colors"
                                        >
                                            Send Message
                                        </button>
                                    </form>
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div>
                                            <h3 className="text-white font-semibold text-lg">Visit Our Showroom</h3>
                                            <p className="text-gray-400">123 Motor Street</p>
                                            <p className="text-gray-400">Speed City, SC 12345</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-400">Sales: (555) 123-4567</p>
                                            <p className="text-gray-400">Service: (555) 123-4568</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-400">service@senkemotors.com</p>
                                        </div>
                                    </div>
                            ...
                            {/* Map */}
                            <div className="bg-dark rounded-xl overflow-hidden h-64">
                                <iframe
                            ...
                            <div>
                                ...
                                <div className="flex space-x-4">
                                    <a href="#" className="bg-darker p-3 rounded-lg text-gray-400 hover:text-primary hover:bg-gray-800 transition-all">
